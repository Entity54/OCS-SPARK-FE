        ...
        <div className="px-4 py-3 page-body">
            <form className="row g-3">
                <div className="col-12" style={{color:"#06E443"}}>
                    <h3>Assets to use for Example Marketing Campaign</h3>
                </div>
                ...
                <h5>Click the button below to withdraw all platform Fees (You must be signed in with the smart contract account deployer account)</h5>
                <div className="col-12">
